...
export default function FileUploader() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    alert("File upload simulation complete! Check the console for details.")
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {file.preview ? (
                    ...
                    <div className="flex flex-col items-center justify-center aspect-square rounded-lg border border-gray-200 bg-gray-50 p-4">
                      <div className="text-center">
                        <p className="text-sm text-gray-500 truncate max-w-[120px]">{file.name}</p>
        ...
        <Button type="submit" className="w-full sm:w-auto" disabled={selectedFiles.length === 0}>
          Upload Files
        </Button>
      </form>
    </div>
